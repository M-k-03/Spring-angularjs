...
public class SpringMVCController {
	...
	@RequestMapping(value = "/PostFormDataByParam1", method = RequestMethod.POST)
	public @ResponseBody Person PostFormDataByParam1(HttpServletRequest request) {
	...
	public @ResponseBody Person PostFormDataByParam(@RequestBody Person person) {
